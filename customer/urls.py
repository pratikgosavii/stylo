...
path('products/<int:product_id>/reviews/', ProductReviewsAPIView.as_view(), name='product_reviews'),
...
path("orders/with-ordered-items/", OrdersWithOrderedItemsAPIView.as_view(), name="customer-orders-with-ordered-items"),
path("orders/without-ordered-items/", OrdersWithoutOrderedItemsAPIView.as_view(), name="customer-orders-without-ordered-items"),
